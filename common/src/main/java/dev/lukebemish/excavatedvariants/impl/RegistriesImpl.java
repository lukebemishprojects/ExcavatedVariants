...
public final class RegistriesImpl {
    ...
    public static void bootstrap() {
        ((MappedRegistryAccessor) GROUND_TYPE_REGISTRY).setFrozen(false);
        ((MappedRegistryAccessor) ORE_REGISTRY).setFrozen(false);
        ((MappedRegistryAccessor) STONE_REGISTRY).setFrozen(false);
        ((MappedRegistryAccessor) MODIFIER_REGISTRY).setFrozen(false);
